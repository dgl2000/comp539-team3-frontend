...
import { Input, Button, Grid, Header, Image } from "semantic-ui-react";

// const backend_url = (path) => `https://team3-dot-rice-comp-539-spring-2022.uk.r.appspot.com/api/v1/${path}`;
